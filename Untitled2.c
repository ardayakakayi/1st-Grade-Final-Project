...
sec:											 //
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\Amelie.wav"), NULL, SND_ASYNC);
		int halo;
		music_list();
		printf(BHRED);
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\Maine.wav"), NULL, SND_ASYNC);
		music_list();
		printf(BHRED);
		printf("\n\t\t\t  Maine oynatiliyor...");
		printf("\n\t\t\t\t  >>");
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\Promise.wav"), NULL, SND_ASYNC);
		music_list();
		printf(BHRED);
		printf("\n\t\t\t  Promise oynatiliyor...");
		printf("\n\t\t\t\t  >>");
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\Paul.wav"), NULL, SND_ASYNC);
		music_list();
		printf(BHRED);
		printf("\n\t\t\t  Paul oynatiliyor...");
		printf("\n\t\t\t\t  >>");
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\Thong.wav"), NULL, SND_ASYNC);
		music_list();
		printf(BHRED);
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\FeelsLike.wav"), NULL, SND_ASYNC);
		music_list();
		printf(BHRED);
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\Innocence.wav"), NULL, SND_ASYNC);
		music_list();
		printf(BHRED);
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\Milk.wav"), NULL, SND_ASYNC);
		music_list();
		printf(BHRED);
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\Rose.wav"), NULL, SND_ASYNC);
		music_list();
		printf(BHRED);
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\Syrup.wav"), NULL, SND_ASYNC);
		music_list();
		printf(BHRED);
	...
	{
		system("cls");
		PlaySound(TEXT("C:\\Users\\Public\\Documents\\Musics\\Youth.wav"), NULL, SND_ASYNC);
		music_list();
		printf(BHRED);
		printf("\n\t\t\t   Youth oynatiliyor...");
		printf("\n\t\t\t\t  >>");
...
tekrar:
	...
	{												  //
		...
		sleep(2);									  //
		menu();
	} //			Kullanicidan alinan cevaba gore yonlendirme
...
tekrar:
	...
	for (i = 0; i < 30; i++)
	{													// for dongusu ile bastan id atanmasi yapildi	//
		fscanf(fptr, "%d\n", &questiontext.questionID); //
		...
		if (feof(fptr))
		{ // dosyanin sonuna gelindiginde donguden cikar
			break;
		} //
...
jump:
	...
	printf("\n\n\t\t      Listeye tekrar goz atmak ister misiniz?Ana menuye donmek i�in 'geri' yazabilirsiniz..");
	printf("\n\n\n\n\n\t\t\t\t\t\t\t>> ");
	char evethayir[10];
	char yesno[10];
	char dikkat[10];
...
tekrar:
	...
	if (strcmp(eveth, "evet") == 0)
	{
		...
		sleep(1);
		printf(BHMAG);
		printf("� "); // yorumlar ve puanlama alinarak cikis sayfasina ulasilir.Yukleme ile kullaniciya veda edilir
		sleep(1);
		printf(BHCYN);
		printf("� ");
		sleep(1);
...
void menu()
{
	...
	printf("\n\t\t\t    1-M�zik dinlemek ister misiniz?\n\t\t\t    2-Soru ekle\n\t\t\t    3-Sorulari listele ve g�ncelle \n\t\t\t    4-Soru sil \n\t\t\t    5-Oyuna Var misin? \n\t\t\t    6-Rakiplerim kim?\n\t\t\t    7-Hakkimizda\n\t\t\t    8-Cikis");
	int a;
	printf("\n\n\t\t\t\t\t\t\t      >> ");
	scanf("%d", &a);
	int i;
	...
	case 3:												 //
		...
		sleep(1);										 //
		printf("  .");									 //
		sleep(1);										 //			Menu fonskiyonlari atanmistir.Girilen numaraya g�re fonksiyon calisir
		printf("  .");									 //
		fsorularigoster();								 //
		break;											 //
	case 4:												 //
...
void frandomsayilar()
{
	...
	///////////////////Random soru sayisi almak icin yazilmistir.Soru sayisi tan�mlaniyor.Count degerine ataniyor
...
void fscores()
{
	...
	for (j = 0; j < i - 1; j++)
	{
		for (k = 0; k < i - j - 1; k++)
		{
			...
			{ // Bubble sort ile skorlarin s�ralanmasi saglanmistir
